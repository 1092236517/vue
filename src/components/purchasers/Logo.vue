    ...
    <div class="status-wrapper">
        ...
        <div class="logoBox">
            ...
            <p class="uploat-btn-wrapper">
                ...
                <input type="file" ref="uploadInput" id="upload" @change="uploadImg">
            </p>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getAuthority(){
                let that=this;
                if(that.$store.getters.authForGroup.NormalBranchLogo && that.$store.getters.authForGroup.NormalBranchLogo.transfers.length != 0){
                    that.$store.getters.authForGroup.NormalBranchLogo.transfers.map(item => {
            ...
            openClipWindow(){
                ...
                this.cropperOption.src = null; //重置画布
            ...
            uploadImg(e){
                ...
                if(!e.target.value){ //非空判断（点击取消时触发）
                    return false
                }
