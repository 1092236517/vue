			...
			<el-collapse class="operate-log">
				<el-collapse-item title="查看详情" name="1">
					<el-table :data="stepData.operateData" stripe style="width: 100%">
                        <el-table-column prop="demander" label="需求提交人"></el-table-column>
                        ...
                        <el-table-column prop="duration" label="历时时间"></el-table-column>
                        <el-table-column prop="approveStatus" label="审核状态"></el-table-column>
