    ...
    export default {
        ...
        methods: {
            ...
            addDemand(){
                ...
                if(that.isNew){
                    json = dialogJsonCopy;
                    url = '/api/frontend/joint_purchase/super/branch/order/create_slave_order';
                }else if(that.isEdit){
                    json = dialogJsonCopy;
                    url = "/api/frontend/joint_purchase/super/branch/order/update_slave_order/"+that.editId;
                }else{
                    json = {
                        token: that.token,
                    ...
                    url = "/api/frontend/joint_purchase/super/branch/order/sign_slave_order/"+that.editId;
                }
            ...
            approveVolumePrice(params, id){
                let that = this;
                that.$api.branchConfirmVolumePrice(params, id)
                    .then(response => {
            ...
            getStepsData(slave_order_id){
                ...
                that.$api.branchBatchOrderProcess(params)
                    .then(response => {
                        let result = response.data;
                        if(result.msg_code == 100000){
            ...
            getStepsLog(id){
                ...
                that.$api.branchBatchOrderLogList(params, id)
                    .then(response => {
                        let result = response.data;
                        if(result.msg_code == 100000){
            ...
            calculatePriceForNum(item){
                ...
                if(reg.test(item.num)){
                    ...
                    that.$api.NetworkPriceCount_branch(params).then(response=>{
                        if(response.data.msg_code===100000){
