    ...
    <div>
        ...
        <el-form :inline="true" label-width="80px">
            ...
            <el-form-item label="品牌">
                <span class="requiredSpan">*</span>
                <el-input v-model="dialogJson.brand_name" placeholder="请输入品牌" class="width300" :disabled="!isInput"></el-input>
            </el-form-item>
        </el-form>
        <el-form :inline="true" label-width="80px">
            <el-form-item label="数量">
                <span class="requiredSpan">*</span>
                <el-input v-model="dialogJson.purchase_num" :placeholder="placeholderMax" class="width210" :disabled="!isInput"></el-input>
            </el-form-item>
        ...
        <el-form ref="form" label-width="150px">
            ...
            <el-form-item >
                <el-checkbox style="margin-left: -150px;" v-model="dialogChecked"></el-checkbox>
                <span class="agreement" @click="readPurchaseAgreement">阅读采购协议</span>
            </el-form-item>
        </el-form>
...
export default {
    ...
    methods:{
        ...
        showThisItem(id){
            ...
            that.$http.get('/api/frontend/joint_purchase/super/branch/demand/detail/'+id ,{ params }).then(function (response) {
        ...
        addDemand(){
            ...
            if(that.dialogChecked){
                ...
                that.demandSubmitDisabled = false;
                that.$alert('请先勾选《阅读采购协议》', '提示', {
                    confirmButtonText: '去勾选'
                })
            }
        },
        //产品分类
        ...
        //阅读采购协议
        readPurchaseAgreement(){
            let { href } = this.$router.resolve({name: 'purchaseAgreement_super'});
            //todo 内容还未提供，先隐藏跳转
            //window.open(href);
        }
    },
