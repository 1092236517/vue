    ...
    export default {
        ...
        methods: {
        	...
        	getMsgList(status,curPage){
				...
				let url = "";
				if(that.userId == 1){
					url = '/api/frontend/joint_purchase/super/group/message/lists'
				}else if(that.userId == 2){
					url = '/api/frontend/joint_purchase/super/branch/message/lists'
				}else{
					url = '/api/frontend/joint_purchase/super/supplier/message/lists'
				}		
