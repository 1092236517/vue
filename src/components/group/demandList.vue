...
<!--         <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-table :data="demandLists" style="width: 100%" border>
            ...
            <el-table-column prop="purchase_num" label="采购数量"></el-table-column>
            <el-table-column prop="goods_amount" label="已核货量" width="200" v-if="approvedVolumeBtn">
                <template slot-scope="scope">
                    <el-input v-model="scope.row.goods_amount" placeholder="已核货量" :disabled="scope.row.disable" @blur="goodNum(scope.row)"></el-input><i class="iconfont icon-qianbipencil82 exitfont" @click="editamount(scope.row)"></i>
                </template>
            </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            ...
            getAuthority(){
                let that = this;
                if(that.$store.getters.authForGroup.NormalJointPurchaseDemandList&&that.$store.getters.authForGroup.NormalJointPurchaseDemandList.transfers.length!=0){
