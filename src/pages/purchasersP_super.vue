<template>
    <div class="main-box">
        <!-- <left-purch class="leftDiv"></left-purch> -->
...
<script>
    // import leftPurch from '../components/purchasers_super/leftPurch'
    import sideBarMenu from '../components/public/SideBarMenu'
    import headPurch from '../components/purchasers_super/headPurch'

    export default {
        name: "purchasersP_jiangjian",
